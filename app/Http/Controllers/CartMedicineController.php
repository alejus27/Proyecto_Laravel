...
use App\Models\CartMedicine;
use Illuminate\Http\Request;

class CartMedicineController extends Controller
{
    public function index(){
        return response()->json(CartMedicine::all(),200);   //Hace referencia al modelo
    }
    
    //Mostrar un solo elemento filtrado por el id
    public function show($id){
        $the_cartMedicine=CartMedicine::find($id);
    ...
    public function store(Request $request){
        $the_cartMedicine=CartMedicine::create($request->all());
